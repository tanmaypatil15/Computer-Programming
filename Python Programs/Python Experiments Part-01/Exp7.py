#Write python program to understand different types of Exceptions 
i=1
while i<=5: 
    ...
    if n==1: 
        ...
        try: 
            ...
            print("Oops! Name Error Exception Occurs due to c=k/b (k is not defined ).Please enter valid variable number.") 
    elif n==4: 
        try: 
            r='2'+2 
        except TypeError: 
